...
<head>
    ...
    <title>Reply to Post under a Topic</title>
...
<body>
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	   ...
	   <fieldset>
	      ...
	      <legend>Post Your Reply in <?php echo $topic_title; ?></legend>
		  
		  <p><label for="post_owner">Your Email Address:</label><br/>
          <input type="email" id="post_owner" name="post_owner" size=28" maxlength="100" required="required"></p>
		  
		  <p><label for="post_text">Post Text:</label><br/>
          <textarea id="post_text" name="post_text" rows="8" cols="32" required="required"></textarea></p>
		  
		  <input type="hidden" name="topic_id" value="<?php echo $topic_id; ?>">
          <br>
		  
		  <button class="btn default" type="submit" name="submit" value="submit">Add Post</button><br><br>
...
<br><br>
<h3>Your <a href="addtopic.html">topic </a>can be added here.</h3>
<br><br>
<br><br>
<footer>
