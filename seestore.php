<?php
  ...
  $display_block = "<h1>Product Categories</h1><br><br>
  <p>Select a category to see its items.</p><br>";
  ...
  else
  {
     ...
     while ($cats = mysqli_fetch_array($get_cats_res)) 
	 {
        ...
        "?cat_id=".$cat_id."\">".$cat_title."</a></strong><br/>".$cat_desc."</p><br>";
	   ...
	   else 
	   {
           ...
           while ($items = mysqli_fetch_array($get_items_res)) 
		   {
               ...
               $display_block .= "<li><a href=\"showitem.php?item_id=".
                     $item_id."\">".$item_title."</a> (\$".$item_price.")</li><br>";
           }
